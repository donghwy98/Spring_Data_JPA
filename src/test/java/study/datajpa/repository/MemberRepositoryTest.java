...
class MemberRepositoryTest {
    ...
    public void testMember() {
        Member member = new Member("경기대박서준");
    ...
    public void returnType() {
        ...
        List<Member> returnList = memberRepository.findListByUsername("AAA");
        for(Member m : returnList) {
            System.out.println("findList = " + m);
        }

        Member returnMember = memberRepository.findMemberByUsername("BBB");
        System.out.println("findMember = " + returnMember);

        Optional<Member> returnOptional = memberRepository.findOptionalByUsername("CCC");
        System.out.println("findOptional = " + returnOptional.get());
    }
    ...
    public void bulkUpdate() {
        ...
        //when
        int result = memberRepository.bulkAgePlus(30);
